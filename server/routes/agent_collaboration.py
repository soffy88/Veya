...
async def create_task(request: CreateTaskRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        task_id = collaborator.create_task(
            request.description,
            role,
...
async def complete_task(request: CompleteTaskRequest) -> Dict[str, Any]:
    ...
    try:
        success = collaborator.complete_task(
            request.task_id,
            request.result,
            request.error
        )
...
async def get_collaboration_summary() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get collaboration summary: {str(e)}")
