...
_RULES: list[tuple[str, str, dict[str, Any], str | None, str]] = [
    (
        "gemstone/glass",
        r"jade|gem|glass|crystal|translucent|transparent|amber|resin",
        {
            "transmission": 0.6,
            "ior": 1.6,
            "thickness": 0.5,
        ...
        None,
        "translucent → transmission+ior+thickness; needs an environment map to read correctly",
    ),
    (
        "brushed-metal",
        r"brushed|anisotropic|satin metal|machined",
        {
            "metalness": 1.0,
            "roughness": 0.35,
            "anisotropy": 0.6,
        ...
        None,
        "brushed metal → anisotropy for the directional highlight streak",
    ),
    (
        "metal",
        r"metal|steel|chrome|gold|silver|brass|copper|iron|alumin",
        {"metalness": 1.0, "roughness": 0.3, "requiresEnvMap": True},
        None,
        "metal → metalness 1 + low roughness + env map",
    ),
    (
        "glossy-coat",
        r"gloss|glossy|lacquer|wet look|polished paint|clear ?coat|enamel|varnish",
        {"clearcoat": 1.0, "clearcoatRoughness": 0.1, "requiresEnvMap": True},
        None,
        "glossy paint → clearcoat 1.0 + low clearcoatRoughness",
    ),
    (
        "iridescent",
        r"iridescen|oil ?slick|soap|pearlescent|nacre|holograph",
        {"iridescence": 1.0, "iridescenceIOR": 1.3, "requiresEnvMap": True},
        None,
        "iridescent → iridescence + iridescenceIOR",
    ),
    (
        "fabric",
        r"fabric|cloth|velvet|suede|felt|textile|woven|denim|cotton",
        {
            "sheen": 1.0,
            "sheenColor": "#ffffff",
            "sheenRoughness": 0.5,
        ...
        None,
        "fabric → sheen for the soft grazing-angle retroreflection",
    ),
    (
        "emissive",
        r"emissive|glow|glowing|led|neon|luminous|backlit|screen|display",
        {"emissive": "#ffffff", "emissiveIntensity": 1.0},
        None,
        "emissive/glowing → emissive + emissiveIntensity",
    ),
    (
        "rubber/matte",
        r"rubber|matte plastic|matte|grip|polymer|abs plastic",
        {"metalness": 0.0, "roughness": 0.8},
        None,
        "matte polymer → high roughness, non-metal",
    ),
    (
        "fastener",
        r"screw|rivet|bolt|stud|fastener|nut|nail|grommet|eyelet",
        {},
        "instanced-cluster",
        "repeated fasteners → instancing (InstancedMesh), not N meshes",
    ),
    (
        "decal",
        r"logo|emblem|stamp|decal|marking|engrav|wordmark|serial|inscription|label",
        {},
        "decal",
        "flat marking → DecalGeometry stamped onto the surface",
    ),
]
