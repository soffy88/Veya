...
_ELEMENT_MAP: dict[str, tuple[str, str]] = {
    ...
    "PHASES": ("oprim", "PHASES"),
    # ── 工程工作流原语 (mattpocock skills 3O 内化, oskill v4.17.0) ──
    "InterviewQuestion": ("oskill", "InterviewQuestion"),
    "InterviewState": ("oskill", "InterviewState"),
    "interview_frontier": ("oskill", "interview_frontier"),
    "interview_pending_facts": ("oskill", "interview_pending_facts"),
    "interview_progress": ("oskill", "interview_progress"),
    "is_interview_complete": ("oskill", "is_interview_complete"),
    "record_interview_answers": ("oskill", "record_interview_answers"),
    "record_interview_facts": ("oskill", "record_interview_facts"),
    "resolve_interview_answer": ("oskill", "resolve_interview_answer"),
    "ReviewFinding": ("oskill", "ReviewFinding"),
    "ReviewReport": ("oskill", "ReviewReport"),
    "review_diff": ("oskill", "review_diff"),
    "scan_spec_coverage": ("oskill", "scan_spec_coverage"),
    "scan_standards": ("oskill", "scan_standards"),
    "AdrDraft": ("oskill", "AdrDraft"),
    "read_glossary": ("oskill", "read_glossary"),
    "upsert_term": ("oskill", "upsert_term"),
    "should_write_adr": ("oskill", "should_write_adr"),
    "write_adr": ("oskill", "write_adr"),
    "PipelineAction": ("oskill", "PipelineAction"),
    "Ticket": ("oskill", "Ticket"),
    "WorkflowState": ("oskill", "WorkflowState"),
    "pipeline_next_action": ("oskill", "pipeline_next_action"),
    "pipeline_transition": ("oskill", "pipeline_transition"),
    "ticket_set_status": ("oskill", "ticket_set_status"),
    "tickets_check_cycles": ("oskill", "tickets_check_cycles"),
