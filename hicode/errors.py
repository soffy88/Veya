"""
hicode Error Taxonomy

Structured, machine-readable error hierarchy for all hicode components.
...
class HicodeError(Exception):
    """Root exception for all hicode errors."""

    code: str = "HICODE_UNKNOWN"
    severity: Severity = Severity.ERROR
    component: str = "hicode"
