...
_TABLES = (
    ...
    CREATE TABLE IF NOT EXISTS memory_records (
        ...
        UNIQUE (scope_type, scope_id, memory_type, canonical_fingerprint, id)
    )
    """,
    """
    ...
    CREATE TABLE IF NOT EXISTS skill_versions (
        ...
        status TEXT NOT NULL,
        safety_manifest TEXT NOT NULL,
        safety_scan TEXT NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS learning_records (
        ...
        evidence_trajectory_ids TEXT NOT NULL,
...
_INDEXES = (
    ...
    "CREATE INDEX IF NOT EXISTS memory_candidate_idx ON memory_candidates (scope_type, scope_id, status, created_at)",
    "CREATE INDEX IF NOT EXISTS skill_scope_idx ON skill_records (scope_type, scope_id, status, updated_at)",
    "CREATE INDEX IF NOT EXISTS skill_version_idx ON skill_versions (skill_id, status, version DESC)",
    "CREATE INDEX IF NOT EXISTS skill_run_idx ON skill_runs (skill_id, version, created_at)",
    "CREATE INDEX IF NOT EXISTS continuity_lookup_idx ON continuity_snapshots (user_id, workspace_id, generated_at DESC)",
